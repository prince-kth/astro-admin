...
const monthlyFortuneSchema = z.object({
  ...
  highlights: z.array(z.string()).describe("Key astrological highlights for the month, including planetary transits, aspect influences and their effects on various areas of life. The highlights should be at least 10 words and provide actionable insights to the user"),
