...
const companyDetailsSchema = z.object({
  ...
  slogan: z.string().describe("Company slogan or tagline"),
  year: z.string().describe("Establishment year of the company"),
  ...
  email: z.string().describe("Company email address"),
  report_name: z.string().describe("Name of the report"),
  astrologer_name: z.string().describe("Name of the astrologer"),
...
const monthlyFortuneSchema = z.object({
  ...
  highlights: z.array(z.string()).describe("Key astrological highlights for the month must be at least 30 words"),
  focus_areas: z.object({
    love_relationships: z.string().describe("Love and relationships predictions for the month must be at least 20 words"),
    career_finances: z.string().describe("Career and financial predictions for the month must be at least 20 words"),
    health_wellness: z.string().describe("Health and wellness predictions for the month must be at least 20 words"),
    lucky_symbols: z.string().describe("Lucky symbols and numbers for the month must be at least 20 words"),
    remedies: z.string().describe("Recommended remedies for the month must be at least 20 words")
  })
});
