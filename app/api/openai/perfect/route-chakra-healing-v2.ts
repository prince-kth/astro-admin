...
1. Financial Doshas (Must include all of these for each dosha):
   ...
   - Benefits when absent (must be specified)
        ...
        schema: z.object({
          ...
          doshas: z.object({
            financial_doshas: z.array(z.object({
              ...
              benefits_when_absent: z.object({
                career: z.string().min(1, "Career benefit must not be empty"),
                wealth: z.string().min(1, "Wealth benefit must not be empty"),
                mental_peace: z.string().min(1, "Mental peace benefit must not be empty")
              }),
            ...
            relationship_doshas: z.array(z.object({
              ...
              benefits_when_absent: z.object({
                marriage: z.string().min(1, "Marriage benefit must not be empty"),
                family_life: z.string().min(1, "Family life benefit must not be empty"),
                relationships: z.string().min(1, "Relationships benefit must not be empty")
              }),
              remedies: z.string().min(1, "Remedies must not be empty")
            ...
            health_doshas: z.array(z.object({
              ...
              benefits_when_absent: z.object({
                mental_health: z.string().min(1, "Mental health benefit must not be empty"),
                physical_health: z.string().min(1, "Physical health benefit must not be empty"),
                emotional_stability: z.string().min(1, "Emotional stability benefit must not be empty")
              }),
